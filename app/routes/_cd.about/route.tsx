	...
	return (
		<>
			...
			<Section aria-label="Profile" css={css.raw({ display: 'flex', flexDirection: 'column', rowGap: '1rem' })}>
				<Heading bold prefix css={css.raw({ fontSize: 'l' })} type="block">
					Profile
				</Heading>
			...
			<Section aria-label="Skills" css={css.raw({ display: 'flex', flexDirection: 'column', rowGap: '1rem' })}>
				...
				<Section aria-label="Language">
					<Heading bold prefix css={css.raw({ fontSize: 'm' })} type="block">
						Language
					</Heading>
			...
			<Section aria-label="SNS">
				...
				<p className={css({ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' })}>
					<SocialLink href="https://github.com/re-taro" icon={Github}>
						GitHub
					</SocialLink>
					<SocialLink href="https://twitter.com/re_taro_" icon={Twitter}>
						Twitter
					</SocialLink>
					<SocialLink href="https://blog.re-taro.dev" icon={Blog}>
						Blog
					</SocialLink>
					<SocialLink href="https://bsky.app/profile/re-taro.dev" icon={Bluesky}>
						Bluesky
					</SocialLink>
					<SocialLink href="https://discord.com/users/713739439041544273" icon={Discord}>
						Discord
					</SocialLink>
					<SocialLink href="https://keybase.io/10969_rintaro" icon={Keybase}>
						Keybase
					</SocialLink>
					<SocialLink
						href="https://keys.openpgp.org/vks/v1/by-fingerprint/60EC8DD6265105FFDD3D6EFEB3BBD234590C77FC"
						icon={Monkeytie}>
						GPG Keys
					</SocialLink>
					<SocialLink href="mailto:me@re-taro.dev" icon={MailLine}>
						me&#64;re-taro.dev
					</SocialLink>
				</p>
			</Section>
